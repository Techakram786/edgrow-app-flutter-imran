...
class JobRecommendedRepository {

  Future<dynamic> getJobRecommended(var params,String token) async {
    Completer<dynamic> completer = Completer<dynamic>();

    try {
      API api = API(url: ApiUrl.baseUrl + ApiUrl.endpointOnJobRecommended);
      api.get(
