...
class MyJobRepository {
  ...
  Future<dynamic> getMyJobCount(String token) async {
    Completer<dynamic> completer = Completer<dynamic>();

    try {
      API api = API(url: ApiUrl.baseUrl + ApiUrl.endpointOnMyJobsCount);
      api.get(
        bearerToken: token,
  ...
  Future<dynamic> getMyJob(var params,String token) async {
    Completer<dynamic> completer = Completer<dynamic>();

    try {
      API api = API(url: ApiUrl.baseUrl + ApiUrl.endpointOnMyJobs);
      api.post(
  ...
  Future<dynamic> searchJobs(var params,String token) async {
    Completer<dynamic> completer = Completer<dynamic>();

    try {
      API api = API(url: ApiUrl.baseUrl + ApiUrl.endpointOnMyJobsSearch);
      api.post(
        queryParameters:params ,
        bearerToken: token,
        onApiSuccess: (response) {
