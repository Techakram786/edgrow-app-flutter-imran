...
class SecondRoundRepository {

  Future<dynamic> getTopicDtl(var params,String token) async {
    Completer<dynamic> completer = Completer<dynamic>();

    try {
      API api = API(url: ApiUrl.baseUrl + ApiUrl.endpointOnSecondRoundTopic);
      api.post(
  ...
  Future<dynamic> secondRoundApply(var params,String token) async {
    Completer<dynamic> completer = Completer<dynamic>();

    try {
      API api = API(url: ApiUrl.baseUrl + ApiUrl.endpointOnSecondRoundApply);
      api.post(
        queryParameters:params ,
        bearerToken: token,
        onApiSuccess: (response) {
