...
import '../view_model/job_type_controller.dart';


class JobTypeScreen extends StatelessWidget {
  final JobTypeController _controller = Get.put(JobTypeController());
              ...
              body: ListView(
                ...
                children: [
                  ...
                  Commontextformfeild(
                    ...
                    maxLines: 1,
                    minLines: 1,
                    hintText: 'Type your Languages Known',
                    isPassword: false,
                    isSuffixPressed: () {},
                    isObscureText: false,
                  ...
                  Obx(
                    ...
                    _controller.isSearch.value
                        ...
                        : _buildGridViewApi(_controller.jobTypeList),
                  ),
                ],
              ),
                    ...
                    Obx(
                        ...
                        onPressed: () async {
                          RxList<String> list = _controller
                              ...
                              .obs;
                          if (list.isNotEmpty) {
                            _controller.updateJobtypeApi(list: list);
                          } else {
                            Get.snackbar(
                              'Language',
  ...
  Widget _buildGridView(RxList<JobTypeModel> loc) {
  ...
  Widget _buildGridViewApi(RxList<JobTypeModel> loc) {
    return GridView.builder(
      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
        crossAxisCount: 3,
        mainAxisExtent: 45,
