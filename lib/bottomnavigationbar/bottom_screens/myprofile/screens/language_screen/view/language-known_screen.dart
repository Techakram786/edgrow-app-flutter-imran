...
class LanguageKnownScreen extends StatelessWidget {
  final LanguageController _controller = Get.put(LanguageController());

  final TextEditingController _textController = TextEditingController();

  LanguageKnownScreen({super.key});
                ...
                children: [
                  ...
                  Obx(
                    ...
                    _controller.isSearch.value
                        ...
                        : _buildGridViewApi(_controller.languageList),
                  ),
                ],
              ),
                    ...
                    Obx(
                        ...
                        onPressed: () async {
                          RxList<String> list = _controller
                              ...
                              .obs;
                          if (list.isNotEmpty) {
                            _controller.updateLanguageApi(loc: list);
                          } else {
                            Get.snackbar(
                              'Language',
  ...
  Widget _buildGridView(RxList<LanguageModel> loc) {
  ...
  Widget _buildGridViewApi(RxList<LanguageModel> loc) {
    return GridView.builder(
      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
        crossAxisCount: 3,
        mainAxisExtent: 45,
