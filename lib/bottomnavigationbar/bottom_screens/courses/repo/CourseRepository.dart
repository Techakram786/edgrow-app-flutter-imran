...
class CoursesRepository{
  ...
  Future<dynamic> getCoursesCategory(String token) async {
    Completer<dynamic> completer = Completer<dynamic>();
    try {
      API api = API(url: ApiUrl.baseUrl + ApiUrl.endpointOnCoursesCategory);
      api.get(
        bearerToken: token,
  ...
  Future<dynamic> getCourses(String token,var params) async {
    Completer<dynamic> completer = Completer<dynamic>();
    try {
      API api = API(url: ApiUrl.baseUrl + ApiUrl.endpointOnCourses);
      api.post(
  ...
  Future<dynamic> getSearchCourses(String token,var params) async {
    Completer<dynamic> completer = Completer<dynamic>();
    try {
      API api = API(url: ApiUrl.baseUrl + ApiUrl.endpointOnSearchCourses);
      api.post(
        queryParameters: params,
        bearerToken: token,
        onApiSuccess: (response) {
