...
class PrefLocRepository{


  Future<dynamic> getPrefLocation() async {


    Completer<dynamic> completer = Completer<dynamic>();

    try {
      API api = API(url: ApiUrl.baseUrl + ApiUrl.endpointOnGetPrefLoc);
      api.get(
  ...
  Future<dynamic> updatePrefLoc({required var params}) async {

    Completer<dynamic> completer = Completer<dynamic>();

    try {
      API api = API(url: ApiUrl.baseUrl + ApiUrl.endpointOnUpdatePrefLoc);
      api.post(
