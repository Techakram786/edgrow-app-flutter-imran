...
class ExpectedSalRepository{

  Future<dynamic> updateExpectedSal({required var params}) async {

    Completer<dynamic> completer = Completer<dynamic>();

    try {
      API api = API(url: ApiUrl.baseUrl + ApiUrl.endpointOnUpdateExpectedSal);
      api.post(
