...
class UploadCvRepository{
  ...
  Future<dynamic> uploadCv({required var params}) async {

    Completer<dynamic> completer = Completer<dynamic>();

    try {
      API api = API(url: ApiUrl.baseUrl + ApiUrl.endpointOnUploadCv);
      api.post(
  ...
  Future<dynamic> deleteResume(String token,var params) async {
    Completer<dynamic> completer = Completer<dynamic>();
    try {
      API api = API(url: ApiUrl.baseUrl + ApiUrl.endpointOnResumeDlt);
      api.post(
        bearerToken: token,
        queryParameters: params,
        onApiSuccess: (response) {
